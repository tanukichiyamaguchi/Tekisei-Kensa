...
| 版 | 1.4（1.1 版: レビュー指摘 20 件への対応。1.2 版: 最終点検で 07 D07-15・01 D01-35・00 1.1 版との整合を反映。1.3 版: K-06（Supabase → Firebase）に伴う部分改版。1.4 版: Firebase 化後の分冊間整合（02・04 の 2.1 版への回答を反映）。変更点は §13） |
| 作成日 | 2026-09-17（1.1 版: 2026-09-21、1.2 版: 2026-09-21、1.3 版: 2026-09-21、1.4 版: 2026-09-21） |
...
| 職業 | 職業コードを `lib/masters/occupations.ts` で表示名に変換 | `respondents.occupationCode` | 要件定義書 §6.1 U-02、00 §1.10 |
